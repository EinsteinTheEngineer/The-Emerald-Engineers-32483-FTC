...
public class TeleOp_CRFC extends LinearOpMode {
    ...
    private boolean wasCirclePressed = false, wasR1Pressed = false, wasR2Pressed = false, wasXPressed = false, wasL1Pressed = false, wasL2Pressed = false,  wasSquarePressed = false, wasTrianglePressed = false;
    ...
    public void runOpMode() {
        ...
        waitForStart();
            ...
            if (gamepad1.left_trigger > 0.5 && !wasL2Pressed) {
                double rawPower = 1;
            ...
            // --- Reverse Intake & Belt Button (X Button) ---

            if (gamepad1.a && !wasXPressed) {
                intakeMotor.setPower(intakeOn ? 1.0 : 0.0);
                beltMotor.setPower(beltMotorOn ? -1.0 : 0.0);
            }
